...
fun EngineSettingsModal(
    ...
    onDismiss: () -> Unit,
    onSaveConfig: (fps: Int, passThrough: Boolean) -> Unit
) {
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = "GPU & Engine Optimization Settings",
        ...
        text = {
            Column {
                Text(
                    text = "Configure rendering engine refresh rates & low latency network pass-through:",
                    fontSize = 12.sp,
                ...
                Text(
                    text = "Unlocked Frame Rate Target:",
                    fontSize = 13.sp,
                    fontWeight = FontWeight.Bold,
        ...
        confirmButton = {
            Button(
                onClick = {
                    onSaveConfig(selectedFps, passThroughActive)
                    onDismiss()
                },
