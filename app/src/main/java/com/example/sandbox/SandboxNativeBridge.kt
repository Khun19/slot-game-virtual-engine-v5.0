...
class SandboxNativeBridge {
    ...
    external fun interceptRtpPackets(serverHost: String, isSslInterceptionActive: Boolean): String
    external fun injectFridaScript(scriptId: String, scriptName: String, jsCode: String): String
    external fun detachFridaScript(scriptId: String): Boolean
    external fun setGameSpeedMultiplier(multiplier: Float): String
}
